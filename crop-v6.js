...
async function cropImage(inputFile, crops) {
  ...
  for (const crop of crops) {
    ...
    // Focus on top 55% of each cell to avoid text labels
...
(async () => {
  // Re-crop greek2-v3 (the new Gemini image for sheet 2)
  await cropImage('assets/images/greek2-v3.png', [
  ...
  // Also re-crop greek1-v2 (sheet 1)
